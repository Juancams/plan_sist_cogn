...
#ifndef COGNITIVE_ARCH__MOVE_HPP_
#define COGNITIVE_ARCH__MOVE_HPP_
...
protected:
  virtual void
  current_pos_callback(const geometry_msgs::msg::PoseWithCovarianceStamped::SharedPtr msg);
...
#endif  // COGNITIVE_ARCH__MOVE_HPP_
